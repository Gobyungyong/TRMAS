        ...
        <div>
            ...
            <section>
                <div className="flex justify-center bg-white w-100% pt-10 pb-10 ">
                    <div className="text-center text-xl md:text-2xl lg:text-3xl border-b-2 border-solid border-b-gray-950 h-12 justify-center">
                        SERVICE
                    </div>
                </div>
                <div className="flex justify-center bg-white w-100% h-[500px] sm:h-[530px] md:h-[550px] lg:h-[300px] pb-10 ">
                    <div className="lg:flex lg:space-x-60">
                        <div className="text-center mt-10">
                            <div className="text-xl md:text-2xl lg:text-3xl pb-5">3D modeling</div>
                            <span>Accurate</span>
                            <br />
                        ...
                        <div className="text-center mt-10">
                            <div className="text-xl md:text-2xl lg:text-3xl pb-5">projection mapping</div>
            ...
            <section>
                <div
                    ...
                    style={{ backgroundImage: "url('/2.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}
                >
                    ...
                    <div className="flex justify-center w-100% h-[500px] sm:h-[530px] md:h-[550px] lg:h-[300px]  pb-10 ">
                        <div className="lg:flex lg:space-x-60 pt-10">
                            <div className="text-center mt-10">
                                <div className="text-lg md:text-xl lg:text-2xl pb-5 text-white font-semibold">BIM</div>
                            </div>
                            <div className="text-center mt-10">
                            ...
                            <div className="text-center mt-10">
                                <div className="ext-lg md:text-xl lg:text-2xl pb-5 text-white font-semibold">Drone</div>
                            </div>
                        </div>
                    </div>
                </div>
